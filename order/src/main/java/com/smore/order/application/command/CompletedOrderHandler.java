...
public class CompletedOrderHandler implements OutboxHandler {
    ...
    public CompletedOrderHandler(String topic, KafkaTemplate<String, String> kafkaTemplate, Outbox outbox) {
        this.topic = topic;
    ...
    public OutboxResult execute() {
        log.info("CompletedOrderHandler 이벤트 발행 - 도메인 : {}, 이벤트 : {}, orderId : {}, ",
        ...
        try {
            ...
            log.info("CompletedOrderHandler 이벤트 발행 성공 - 도메인 : {}, 이벤트 : {}, orderId : {}, ",
                outbox.getAggregateType(), outbox.getEventType(), outbox.getAggregateId());

            return OutboxResult.SUCCESS;
        } catch (Exception e) {

            log.error("CompletedOrderHandler 이벤트 발행 실패 - 도메인 : {}, 이벤트 : {}, orderId : {}, ",
                outbox.getAggregateType(), outbox.getEventType(), outbox.getAggregateId());
