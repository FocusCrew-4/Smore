...
@Slf4j(topic = "RefundFailedHandler")
public class RefundFailedHandler implements OutboxHandler {
    ...
    public RefundFailedHandler(Tracer tracer, Propagator propagator, String topic, KafkaTemplate<String, String> kafkaTemplate, Outbox outbox) {
    ...
    public OutboxResult execute() {
        log.info("RefundFailed 이벤트 발행 - 도메인 : {}, 이벤트 : {}, orderId : {}, ",
        ...
        try (Tracer.SpanInScope ws = tracer.withSpan(newSpan)) {
            try {
                ...
                log.info("RefundFailed 이벤트 발행 성공 - 도메인 : {}, 이벤트 : {}, orderId : {}, ",
                    outbox.getAggregateType(), outbox.getEventType(), outbox.getAggregateId());
                ...
                log.error("RefundFailed 이벤트 발행 실패 - 도메인 : {}, 이벤트 : {}, orderId : {}, ",
