package com.smore.payment.policy.fee.application;

import com.smore.payment.policy.fee.application.command.CreateFeePolicyCommand;
...
public class FeePolicyService {
    ...
    public void deleteFeePolicy(UUID id, Long userId) {
